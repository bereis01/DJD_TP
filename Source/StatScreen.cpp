        ...
        :UIScreen(game, fontName)
{
    ...
    mHp = AddText("25/25", HP_POS + Vector2(CHAR_WIDTH * 3 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH * 5, WORD_HEIGHT), POINT_SIZE);

    AddText("Strength:", STR_POS, Vector2(CHAR_WIDTH * 9, WORD_HEIGHT), POINT_SIZE);
    mStr = AddText("12", STR_POS + Vector2(CHAR_WIDTH * 9 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH * 2, WORD_HEIGHT), POINT_SIZE);

    AddText("Magic:", MAG_POS, Vector2(CHAR_WIDTH * 6, WORD_HEIGHT), POINT_SIZE);
    mMag = AddText("4", MAG_POS + Vector2(CHAR_WIDTH * 6 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH, WORD_HEIGHT), POINT_SIZE);

    AddText("Skill:", SKL_POS, Vector2(CHAR_WIDTH * 6, WORD_HEIGHT), POINT_SIZE);
    mSkl = AddText("9", SKL_POS + Vector2(CHAR_WIDTH * 6 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH, WORD_HEIGHT), POINT_SIZE);

    AddText("Speed:", SPD_POS, Vector2(CHAR_WIDTH * 6, WORD_HEIGHT), POINT_SIZE);
    mSpd = AddText("9", SPD_POS + Vector2(CHAR_WIDTH * 6 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH, WORD_HEIGHT), POINT_SIZE);

    AddText("Defense:", DEF_POS, Vector2(CHAR_WIDTH * 8, WORD_HEIGHT), POINT_SIZE);
    mDef = AddText("9", DEF_POS + Vector2(CHAR_WIDTH * 8 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH, WORD_HEIGHT), POINT_SIZE);

    AddText("Resistance:", RES_POS, Vector2(CHAR_WIDTH * 11, WORD_HEIGHT), POINT_SIZE);
    mRes = AddText("5", RES_POS + Vector2(CHAR_WIDTH * 11 + WORD_OFFSET, 0), Vector2(CHAR_WIDTH, WORD_HEIGHT), POINT_SIZE);
